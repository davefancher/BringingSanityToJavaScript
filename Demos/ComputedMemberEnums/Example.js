...
(function (ComputedMemberEnums) {
    var getArea = function (r) { return Math.PI * Math.pow(r, 2); };
    var Circles;
    (function (Circles) {
    ...
    function RunDemo() {
        return [0.5, 3, 7, 15].reduce(function (state, current, ix, source) { return state += classifyCircle(current) + "<br />"; }, "").toString();
    }
