...
(function (RpnCalculator) {
    ...
    function solveInternal(stack, value) {
        var apply = function (op) { return applyOperator(stack, op); };
...
(function (ModuleDemo) {
    function RunDemo() {
        return [
            ...
            "90 34 12 33 55 66 + * - + -",
            "90 3 -"
        ].map(function (e) { return ({ expression: e, result: RpnCalculator.solve(e) }); }).reduce(function (p, c) { return p + c.expression + " = " + c.result.toString() + "<br />"; }, "");
    }
